...
{ 
   ...
   if (positionModified){
      ...
      if (lastCommand == OP_BUY_STOP){
         ...
         Print("TRY SELL STOP ------ ", " createPending ", createPending, " sell Pending ", sellPending);
         Print("Tick.ask - ", tick.ask, " next Entry price ", nextEntryPrice, " previous Entry price ", previousEntryPrice);
         ...
         bool createPending = tick.ask <= previousEntryPrice;
         entryPrice = nextEntryPrice;
         Print("TRY BUY STOP ------ ", " createPending ", createPending, " buy Pending ", buyPending);
          Print("Tick.ask - ", tick.ask, " next Entry price ", nextEntryPrice, " previous Entry price ", previousEntryPrice);
